...
/* kobj: i think this code is bugged...
refentity entity num is not always clientnum (check sdk)
sometimes with eth i had that it would not aim for head or find them...
using this clientnum solved it. not doing anythgn with it but if this happens
you know why and you can change it yourself ;]
*/
...
/*		// kobj: 1337 boxes
		...
		// kobj moved body trace here... dont know where else would be good place.
		
//		if(isCommandTime() == 1){
//tes: buggy 			// kobj check body visibility
			if (seth.value[VAR_HITBOX]){
				int i=0;
				ethEntity_t* ent;
